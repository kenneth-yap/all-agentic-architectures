...
export const ensemble: Architecture = {
  ...
  nodes: [
    ...
    { id: "dispatch", type: "a4coordination", label: "Fan-Out\nDispatch",x: 250, y: 150, description: "A4 (Coordination): LangGraph dispatches all three analysts simultaneously in parallel" },
    { id: "bullish",  type: "a2decision",    label: "Bullish\nAnalyst", x: 80,  y: 300, description: "A2 (Decision): optimistic lens — growth catalysts, upside potential" },
    { id: "value",    type: "a2decision",    label: "Value\nAnalyst",   x: 250, y: 300, description: "A2 (Decision): conservative lens — DCF, margin of safety, valuation" },
    { id: "quant",    type: "a2decision",    label: "Quant\nAnalyst",   x: 420, y: 300, description: "A2 (Decision): data lens — technical indicators, momentum, statistical signals" },
    { id: "cio",      type: "a2decision",    label: "CIO\nSynthesizer", x: 250, y: 450, description: "A2 (Decision): receives all three reports and synthesizes a final recommendation" },

...
export const blackboard: Architecture = {
  ...
  comparedTo: [
    ...
    { name: "Meta-Controller", insight: "Meta-Controller dispatches once to the best specialist; Blackboard's controller loops after each agent, re-reading the blackboard to decide who goes next." },
  ],
  nodes: [
    { id: "start",     type: "start",         label: "START",             x: 250, y: 20 },
    { id: "controller",type: "a4coordination", label: "Controller",        x: 250, y: 150, description: "A4 (Coordination): reads the blackboard and decides which agent to activate next" },
    { id: "news",      type: "a2decision",     label: "News\nAnalyst",     x: 80,  y: 300, description: "A2 (Decision): appends news report to blackboard" },
    { id: "technical", type: "a2decision",     label: "Technical\nAnalyst",x: 250, y: 300, description: "A2 (Decision): appends technical report to blackboard" },
    { id: "financial", type: "a2decision",     label: "Financial\nAnalyst",x: 420, y: 300, description: "A2 (Decision): appends financial report to blackboard" },

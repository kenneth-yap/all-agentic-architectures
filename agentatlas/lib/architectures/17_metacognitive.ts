...
export const metacognitive: Architecture = {
  ...
  a1a5Profile: {
    a1input: "User query — any question processed against the agent's self-model before answering",
    a2decision: "Metacognitive analyzer reads self-model against query and produces a strategy + confidence score; resolver executes that strategy",
    a3memory: "Self-model — explicit data structure: knowledge_domain, available_tools, confidence_threshold (first-class, inspectable)",
    a4coordination: "Confidence-based routing to tool (medium confidence), human expert (low confidence), or direct reasoning (high confidence)",
    a5output: "Direct response, tool-augmented answer, or human escalation — matched to the agent's actual capability",
  },
  nodes: [

...
export const rlhf: Architecture = {
  ...
  nodes: [
    ...
    { id: "generate", type: "a2decision", label: "Generate\nDraft",   x: 200, y: 160, description: "A2 (Decision): Junior Copywriter generates email, optionally using past approved examples" },
    { id: "critique", type: "a2decision", label: "Critique\n& Score", x: 200, y: 300, description: "A2 (Decision): Senior Editor scores draft 1-10 and provides specific feedback points" },
    { id: "revise",   type: "a2decision", label: "Revise\nDraft",     x: 440, y: 300, description: "A2 (Decision): rewrites using original draft + critique feedback; loops back to critique" },
    { id: "memory",   type: "a3memory",   label: "Save to\nGold Memory",x: 200, y: 440, description: "A3 (Memory): approved emails stored as few-shot examples for future runs" },

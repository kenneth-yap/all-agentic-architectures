...
function ArchitecturePageInner({ arch }: { arch: NonNullable<ReturnType<typeof getArchitecture>> }) {
  ...
  // Prev / Next architecture navigation
...
export default function ArchitecturePage({ params }: Props) {
  ...
  return <ArchitecturePageInner arch={arch} />;
}
